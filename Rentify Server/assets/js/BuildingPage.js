...
const renderTable = (filteredBuildings = building) => {
    ...
    filteredBuildings.forEach((item, index) => {
        ...
        <td style="vertical-align: middle;">${item.manager_id ? item.manager_id.username || "" : ""}</td>
        <td style="vertical-align: middle;">${item.manager_id ? item.manager_id.phoneNumber || "" : ""}</td>
